...
if(isset($_POST['tambah'])) {
    ...
    $sql = "INSERT INTO kamar(no_kamar, tipe_kamar, harga_kamar)
    VALUES('$no_kamar', '$tipe_kamar', '$harga_kamar')";
              ...
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" name="no_kamar" class="form-control" id="exampleInputEmail1" placeholder="">
                  </div>
                  <div class="form-group">
                  <label for="exampleSelectBorder">Tipe Kamar</label>
                  <select class="custom-select form-control-border" name="tipe_kamar" id="exampleSelectBorder">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="harga_kamar" class="form-control" id="exampleInputEmail1" placeholder="">
                  </div>
                </div>
                <!-- /.card-body -->
