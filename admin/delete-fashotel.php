              ...
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" readonly value="<?= $data['no']; ?>" class="form-control" name="no" id="exampleInputEmail1"  >
                  </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Fasilitas</label>
                    <input type="text" readonly value="<?= $data['fasilitas']; ?>" class="form-control" name="fasilitas" id="exampleInputEmail1"  >
                  </div>
                <!-- /.card-body -->
