  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
          <a href="add-kamar.php" class="btn btn-primary col-md-12 mb-3">Tambah Kamar</a>
            <div class="card">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="edit-kamar.php?no_kamar=<?= $data['no_kamar']; ?>" class="btn btn-warning">Edit</a>
                        <a href="delete-kamar.php?no_kamar=<?= $data['no_kamar']; ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
